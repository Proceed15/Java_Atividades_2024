 ...
 */
package exercicio1listaencadeada;
...
public class ListaEncadeada {
	...
	if(primeiro == null && ultimo==null) //Só tem um elemento na lista
        {
            //Deixar primeiro para mais tarde visualizar na ordem em que inseriu por último.
            primeiro = novoNo;
	}
	primeiro = novoNo;
        numero_nos++;
    ...
    void ExibeLista(){
        ...
        int i = 0;
        while(temp_no!=null){
            JOptionPane.showMessageDialog(null, "Valor " + temp_no.valor + " posicao " +i);
            temp_no = temp_no.prox;
            i++;
        }
    }
